...
design = prompt("Какой тип дизайна? 1 - Шаблон 2 - Уникальный 3 - WOW-Дизайн")
        if(design != 1 && design != 2 && design != 3){
        alert("Такого варианта нет");
        getAnswers();
        return;  
    }
adaptive = prompt("Какой тип адаптивности? 1 - Только ПК 2 - Только мобильный сайт 3 - ПК + Мобильная")   
